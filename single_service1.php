...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
                    ...
                    <div class="single_service_detail">
                        ...
                        <div class="post">
                            <div class="section_title">
                                <div class="title"><h2>TRUST LOGISTICS SERVICES</h2></div>
                            </div>

                            <div class="post_content">
                                <p style="text-align: justify;">
                                    Through our Frightcargo services, we provide expedited Air Freight delivery, Air Cargo and Excess Baggage delivery. Frightcargo Company provides international logistics services and delivery of documents, parcels and freight to over 100 countries around the world.
                                </p>
    ...
    <!--================================
        END ABOUT US AREA
    =================================-->
    <div class="callout" style="padding: 40px 0;background:#333333;color:white;margin-bottom:5px;top:-55px;";>
       <div class="container">
		<div class="row">
			<div class="col-md-6 text-center">
				<h2>Want To Know More About Our Services Offerings.</h2><!-- /.callout-title -->
			</div><!-- /.columns large-6 -->
			...
			<div class="col-md-6">
				<div class="single_info_section">
                                ...
                                <div class="contact_numbers v_middle right_info">
                                    <p><a href="tel:07018373283">07018373283</a></p>
                                </div>
                            </div>
					<span style="color:#006CB7;font-weight: bold;text-transform: uppercase;">
						<span style="display: inline-block;vertical-align: middle;width: 43px;height: 43px;border-radius: 50%;background: #fff;text-align: center;line-height: 43px;font-size: 12px;">Or</span>
					</span>

					<div class="single_info_section">
                                <span class="fa fa-envelope v_middle"></span>
                                <div class="contact_numbers right_info v_middle">
                                    <p><a href="mailto:info@boclassified.com">info@boclassified.com</a></p>
                                </div>
                            </div>
				</div><!-- /.callout-actions -->
			</div><!-- /.columns large-6 -->
