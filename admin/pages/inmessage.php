...
if(isset($_POST['uset'])){
 ...
 $pname = $_POST['pname'];
  ...
  <!-- Main Content -->
      <div class="container-fluid shadow rounded-top h-100 py-2 bg-white p-3 m-3  >
        <section class="section">
          <div class="section-header">
            <h1><i class="fa fa-home " style="font-size:20px"></i><span style="font-size:20px;"> ADD NEW PACKAGE</span></h1>
