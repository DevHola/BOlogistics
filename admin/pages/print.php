  ...
  <!-- Main Content -->
     <div class="container-fluid bg-white shadow h-100 rounded-top py-2 p-3 m-3 >
        ...
        <section class="section">
          ...
          <div class=" row">
            <div class="col">		  
            <h1 style="position:relative;top:-15px;"><i class="fa fa-users" style="font-size:20px"></i><span  style="font-size:20px"> PRINT PACKAGE RECEIPT</span></h1>
          </div>
		  <div class="col">
		   <input type="button" class="btn btn-primary float-right" id="create_pdf" value="Generate PDF">  
		  </div>
		  </div>
...
?>
            ...
            <div style="background: #f5f7f8;width: 100%;height: 100%; font-family: sans-serif; font-weight: 100;" class=" be_container container"> 

<div style="background:#fff;max-width: 600px;margin: 0px auto;padding: 30px;"class="be_inner_containr container"> <div class="be_header">
