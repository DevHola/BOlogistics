...
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.10.19/css/jquery.dataTables.css">
  ...
  <!-- Main Content -->
      <div class="container-fluid bg-white rounded-top shadow h-100 py-2 p-3 m-2" >
        <section class="section">
          <div class="section-header">
            <h1><i class="fa fa-user " style="font-size:20px"></i><span style="font-size:20px;"> MESSAGE MANAGEMENT</span></h1>
