...
?>
  ...
  <!-- Main Content -->
<div class="container-fluid shadow h-100 rounded-top py-2 bg-white p-3 m-2" >

        <section class="section">

          <div class="section-header mb-4">
            <h1><i class="fa fa-users" style="font-size:20px"></i><span style="font-size:20px;"> Package History Update</span></h1>
