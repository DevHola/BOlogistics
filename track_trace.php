...
<head>
    ...
    <title>Frightcargo - Track Your Shipping Status Online</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="tc_title"><h4>Please Enter Your Tracking Number And You Will See Your Shipment Details</h4></div>
                    <div class="tc_form">
            ...
            <div class="container">
                <div class="col-md-6 xs_fullwidth col-xs-6">
                    <div class="footer_text_wrapper">
                        <p class="footer_text">Copyright © Frightcargo. All Rights Reserved by</p>
                    </div>
                </div>
                <div class="col-md-6 xs_fullwidth col-xs-6">
